...
1. Clone the repo by running the command
   ```sh
    git clone https://github.com/V-Blaze/review-past-project
   ```
...
- Feel free to check the [issues page](https://github.com/V-Blaze/review-past-project/issues).
...
- This project is [MIT](https://github.com/V-Blaze/review-past-project/blob/main/LICENSE) licensed.
